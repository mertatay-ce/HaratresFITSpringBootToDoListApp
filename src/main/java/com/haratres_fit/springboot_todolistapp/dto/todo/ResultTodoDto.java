...
public class ResultTodoDto {
    ...
    public ResultTodoDto() {
    }

    public ResultTodoDto(int id, String title, String description, LocalDateTime createdDate, String image_url, TodoState state) {
        this.id = id;
        this.title = title;
